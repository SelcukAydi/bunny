...
struct MockTestManager
{
    ...
    MockTestPerson* m_person_raw_ptr{nullptr};
    ...
    void serialize(Paper &paper, std::string key = "")
    {
        ...
        paper(m_vector, key, FieldTag{8});
        paper(m_person_raw_ptr, key, FieldTag{9});
    }
...
TEST(MockTest, Simple)
{
    ...
    manager1.m_vector.push_back(9090);
    manager1.m_person_raw_ptr = new MockTestPerson{person1};
